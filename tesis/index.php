...
<body class="">
  ...
  <!--   Core JS Files   -->
  <script src="/basedatos/assets/js/core/jquery.min.js"></script>
  <script src="/basedatos/assets/js/core/popper.min.js"></script>
  <script src="/basedatos/assets/js/core/bootstrap.min.js"></script>
  <script src="/basedatos/assets/js/plugins/perfect-scrollbar.jquery.min.js"></script>
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=YOUR_KEY_HERE"></script>
  <!-- Chart JS -->
  <script src="/basedatos/assets/js/plugins/chartjs.min.js"></script>
